...
* PLM    : 
* Case  :   01566123 
* Description : sig abort happens in GenericPipe::queueBuffer
* kernel : none
* user    : used
* TODO : (JB patch)
******************************************************/
#define QUALCOMM_BUGFIX_WFD_AOT_SIGABORT
...
* PLM    :  EF65S 928
* Case  :   01587745 
* Description : while miracast operatiing, framework reset
* kernel : none
* user    : used
* TODO : 
******************************************************/
#define QUALCOMM_BUGFIX_MIRACAST_FRAMEWORK_RESET
