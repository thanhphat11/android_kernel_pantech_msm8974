...
#ifdef FEATURE_PANTECH_TESTMENU_NO_ENTERING
/*
...
/* 
   히든메뉴에 CA on off 메뉴 추가 
*/
#define FEATURE_SKT_CP_CA_SETTING

/* 
    히든메뉴에 TTI/SPS on off 메뉴 추가 
*/
#define FEATURE_SKT_CP_LTE_TTI_SPS_SETTING

/* 
    히든메뉴에 FAST_RETURN_TO_LTE on off 메뉴 추가 
*/
#define FEATURE_SKT_CP_FAST_RETURN_TO_LTE_ONOFF
