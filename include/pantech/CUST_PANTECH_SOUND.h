...
/* To divide VEGA_VT_VoLTE_HEADSET_SPK_STEREO into VEGA_VoLTE_HEADSET_SPK_STEREO and VEGA_VT_HEADSET_SPK_STEREO */
#define FEATURE_PANTECH_SND_HEADSET_VT_VOLTE_DIVISION
#endif
