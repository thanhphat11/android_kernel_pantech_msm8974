...
#define FEATURE_PANTECH_SND_VOICE_LOOPBACK /* For Tx ACDB separation of VOICE loopback test */
 ...
 /* #####################  DOMESTIC Feature ################################################*/
#if defined(T_EF56S) || defined(T_EF59S) || defined(T_EF59K) || defined(T_EF59L) || defined(T_EF60S) || defined(T_EF61K) || defined(T_EF62L) || defined(T_EF63S) || defined(T_EF63K) || defined(T_EF63L) // DOMESTIC
...
#if defined(T_EF56S) || defined(T_EF59S) || defined(T_EF60S) || defined(T_EF63S) // SKT models specific feature
...
#if defined(T_EF59S) || defined(T_EF59K) || defined(T_EF59L) || defined(T_EF63S) || defined(T_EF63K) || defined(T_EF63L) /* EF59/EF63 Series(Dual MIC) specific feature */
...
#if defined(T_EF63S) || defined(T_EF63K) || defined(T_EF63L) /* Dual MIC Recording for EF63 Series */
...
#if defined(T_EF63S) // EF63S will only use below feature
