...
#if defined(CONFIG_PANTECH_CAMERA_EF56_SS) || \
    defined(CONFIG_PANTECH_CAMERA_EF59_SS) || \
    defined(CONFIG_PANTECH_CAMERA_EF60_SS) || \
    (defined(CONFIG_PANTECH_CAMERA_EF63_SS) && (CONFIG_BOARD_VER < CONFIG_WS10))
