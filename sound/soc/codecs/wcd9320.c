...
#if defined(CONFIG_MACH_MSM8974_EF60S) || defined(CONFIG_MACH_MSM8974_EF61K) || \
				       ...
				       struct snd_kcontrol *kcontrol, int event)
{
	...
	/*
	 * 2014-01-27 LS3@SND:
	 * It doesn't need to enable regulator because we got VDD_SPKDRV from
	 * battery "priv->spkdrv_reg" is always NULL.
	 * Unnecessary warning message removal(CASE#01181676)
	 */
...
static const struct wcd9xxx_reg_mask_val taiko_2_0_reg_defaults[] = {
	...
	/* 013-11-28 LS3@SND H/W(KimGyuTae) request(SPK Drive HPF 4Hz -> 75Hz) */
...
/*
 * 2014-02-19 LS3@SND:
 * Impedance detection feature not used for removing pop-up noise.
