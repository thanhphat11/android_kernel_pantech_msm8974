...
/*
 * LS3@SND: Earphone Key Test.
 * Write headset button ADC level for test menu #8378522#.
 */
...
/*
 * 2013-12-16 LS3@SND:
 * Workaround code for 3-pole event removal when 4-pole headset connect slowly.
 */
#ifdef CONFIG_PANTECH_SND
...
static void wcd9xxx_correct_swch_plug(struct work_struct *work)
{
	...
	while (!time_after(jiffies, timeout)) {
		...
		/*
		 * 2014-02-07 LS3@SND:
		 * QCOM workaround for car 4-pole HANDSFREE cable recognition error issue.
		 * CASE#01293496 : [MSM8974] Specific AUX cable is not recognized
		 on current source detection system.
		 */
		      ...
		      bool impedance_det_en)
{
	...
	if (mbhc->headset_jack.jack == NULL) {
		...
		/*
		 * 2013-12-10 LS3@SND BUTTON 1, 2 mapping to 
		 * Volume UP/DOWN key as BUTTON 0
		 */
#ifdef CONFIG_PANTECH_SND
		ret = snd_jack_set_key(mbhc->button_jack.jack,
				       SND_JACK_BTN_1,
